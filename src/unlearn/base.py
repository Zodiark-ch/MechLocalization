...
# `is_torch_tpu_available` has moved/been removed across `transformers` versions.
# Keep this script compatible by falling back to `False` when the symbol is missing.
try:
